...
# -*- coding=utf8 -*-
# author : Shaohui Dong
# description : 爬取陆金所珠江人寿数据
from BeautifulSoup import BeautifulSoup
import sys,os,urllib2,threading
import datetime
import DB

g_root_link = "https://list.lufax.com/list/zhujiang"
g_pro_link = "https://list.lufax.com"
...
def getProDetailInfo(db,proinfo):
	...
	prohref = dict(proinfo.find('a').attrs)['href']
	proUrlLink = g_pro_link + prohref
	...
	write_record_db(db,record_obj,'p2p_product_lufax_zhujiang')
...
if __name__ == '__main__':
	...
	os.system(script_path + '  p2p_product_lufax_zhujiang')
	#os.system('/home/dong/p2p3000/tool/empty_db_table.sh  p2p_product_lufax_zhujiang')
	getProLinks(db)
